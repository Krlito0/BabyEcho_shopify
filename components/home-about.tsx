        ...
        <section className="bg-[#E2F0EB] py-20 px-6">
            <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-12">
                ...
                >
                    ...
                    <a href="/search"
                    className="self-start mt-2 border-2 border-[#D1657C] text-[#D1657C] px-8 py-3 rounded-full font-bold text-sm uppercase tracking-widest hover:bg-[#D1657C] hover:text-white transition-all duration-300"
                    style={{ fontFamily: `var(--font-title)`}}>
